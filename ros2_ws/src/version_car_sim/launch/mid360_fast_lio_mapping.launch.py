...
def launch_setup(context, *args, **kwargs):
    ...
    actions.append(Node(
        ...
        parameters=[{
            ...
            'publish_rate': 5.0,
            'min_range': 0.70,
            'self_filter_x_min': -0.80,
            'self_filter_x_max': 1.20,
            'self_filter_y_min': -0.60,
            'self_filter_y_max': 0.60,
            'self_filter_z_min': -0.25,
            'self_filter_z_max': 1.80,
